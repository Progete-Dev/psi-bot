...
<div class="col-span-1">
    @component('partials.card')
        ...
        @livewire('card-slider',['ids' => $solicitacoes->map(function($solicitacao){ return $solicitacao->id;})->toArray()])
...
@component('partials.card')
    ...
    <div class="flex justify-center w-full">
        @for($i =0 ; $i < $atendimentosDia->count() ; $i++ )
...
@component('partials.card')
    ...
    <div class=" md:flex pb-4 overflow-y-auto  border-t border-gray-300">
        ...
        @foreach(auth()->user()->notificacoes as $notificacao)
