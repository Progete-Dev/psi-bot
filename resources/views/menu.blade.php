...
<div x-data="menu()">
    ...
    <div class="fixed z-40 bottom-0 w-full h-10 bg-indigo-800">
      <div class="relative flex-1 flex flex-col pt-2 w-full ">
        <nav class="px-2 bg-indigo-800  flex justify-center">
            ...
            <a href="http://psi-bot.test/dashboard" class="flex px-3">
              <svg class="ml-1 h-6 w-6 text-indigo-400 group-focus:text-indigo-300 transition ease-in-out duration-150" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
              </svg>
              
            </a>
            <a href="http://psi-bot.test/paciente" class="flex px-3">
              <svg class="ml-1 h-6 w-6 text-indigo-400 group-focus:text-indigo-300 transition ease-in-out duration-150" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path>
              </svg>
              
            </a>
            <a href="http://psi-bot.test/logout" onclick="event.preventDefault();
  ...
  <div x-show="desktop" class="hidden h-full md:flex md:flex-shrink-0"
  x-transition:enter="transition ease-linear duration-500"
  x-transition:enter-start="transform scale-10"
  x-transition:enter-end="transform scale-100"
  x-transition:leave="transition ease-linear duration-600"
  x-transition:leave-start="transform scale-100"
  x-transition:leave-end="transform scale-10">
  ...
  x-transition:leave-start="transform scale-10"
  x-transition:leave-end="transform scale-100"
  x-transition:enter="transition ease-linear duration-600"
  x-transition:enter-start="transform scale-100"
  x-transition:enter-end="transform scale-10">
    <div class="flex flex-col w-16 bg-indigo-800 pt-5 pb-4">
      ...
      <div class="mt-5 flex flex-col px-4">
            <svg  x-on:click="desktop=true" class=" text-white h-6 w-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="mt-5 h-0 flex-1 flex flex-col overflow-y-auto">
        ...
        <nav class="flex-1 px-2 bg-indigo-800">
          <a href="#" class="group flex items-center px-2 py-2 text-sm leading-5 font-medium text-white rounded-md bg-indigo-900 focus:outline-none focus:bg-indigo-700 transition ease-in-out duration-150">
            <svg class="m-auto h-6 w-6 text-indigo-400 group-focus:text-indigo-300 transition ease-in-out duration-150" stroke="currentColor" fill="none" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10M9 21h6"/>
            </svg>
