    ...
    <div class="fixed z-40 bottom-0 w-full h-10 bg-indigo-800">
      <div class="relative flex-1 flex flex-col pt-2 w-full ">
        <nav class="px-2 bg-indigo-800  flex justify-center">
          {{-- Perfil --}}
          <a href="{{route("psicologo.perfil")}}"  class="flex px-3">
    ...
    <div class="flex flex-col  bg-indigo-800 pt-5 pb-4"  :class="{ 'w-12' : !open , 'w-64' : open}">
      ...
      <div class="mt-5 h-0 flex-1 flex flex-col overflow-y-auto">
        ...
        <a x-show="!open" href="{{route('psicologo.perfil')}}" class="group flex items-center  text-sm leading-5 font-medium  rounded-md focus:outline-none focus:bg-indigo-700 transition ease-in-out duration-150 text-indigo-300  hover:text-white hover:bg-indigo-700  focus:text-white mb-4" >
          ...
          {{-- Home --}}
        <a href="{{route('psicologo.home')}}" class="group flex items-center  text-sm leading-5 font-medium  rounded-md focus:outline-none focus:bg-indigo-700 transition ease-in-out duration-150"
          ...
          {{-- Calendario --}}
          <a href="{{route('psicologo.calendario')}}" class="group flex items-center  text-sm leading-5 font-medium  rounded-md focus:outline-none focus:bg-indigo-700 hover:bg-indigo-700  transition ease-in-out duration-150"
            :class="{'text-indigo-300  hover:text-white hover:bg-indigo-700  focus:text-white mb-4' : !open, 'text-white bg-indigo-800 px-2 py-2 mb-2 hover:bg-indigo-700' : open }"
          >
