 <!-- Begin Navbar -->
  ...
  <div x-show.transition.origin.left="desktop" class="hidden h-full md:flex md:flex-shrink-0">
    <div class="flex flex-col w-64 bg-indigo-800 pt-5 pb-4">
      <div class="flex items-center flex-shrink-0 px-8">
        <img src="/img/logos/workflow-logo-on-brand.svg" alt="Workflow" class="h-8 w-2/3">
          <div class="flex">
            <svg x-on:click="desktop=false" class=" text-white h-6 w-6 ml-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
  ...
  <div x-show.immediate="!desktop" class="hidden h-full md:flex md:flex-shrink-0">
    <div class="flex flex-col w-16 bg-indigo-800 pt-5 pb-4">
      <div class="flex items-center flex-shrink-0 px-8">
        
      </div>
      <div class="mt-5 flex flex-col px-4">
        <svg x-on:click="desktop=true" class="text-white h-6 w-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
          <path d="M10 19L3 12M3 12L10 5M3 12L21 12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
        </svg>
      </div>
      <div class="mt-5 h-0 flex-1 flex flex-col overflow-y-auto">
