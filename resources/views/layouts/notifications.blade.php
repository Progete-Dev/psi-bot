@isset($button)
<div x-data="{}" x-init="initTheme();" x-cloak  class="fixed md:bottom-0 md:top-auto top-0 right-0 m-4  p-2 md:w-12 md:h-12  h-10 w-10 bg-menu rounded-full shadow-md">
...
@endisset
@isset($notifications)
<div x-data="{open : false}" x-cloak x-on:notificaoes.window="open = true">
