            ...
            <div class="mt-3 text-center sm:mt-5">
                ...
                <div class="mt-2 text-green-800">
                    <p class="text-md leading-5">
                        Sua solicitação foi enviada para o Psicólogo, você recebará um email com os detalhes da solicitação.
                    </p>
                    <p class="text-md leading-5">
                        Iremos enviar uma mensagem quando o Psicólogo responder a sua solicitação.
                    </p>
                </div>
            </div>
        </div>
