<div>
    <ul class="flex justify-start overflow-x-scroll p-2 w-full mb-2">
        @foreach($events as $horario)
            <li wire:click="dispatchEventAction('{{$horario['id']}}')"  class="block hover:bg-secondary focus:outline-none focus:bg-secondary transition duration-150 ease-in-out bg-white border border-gray-300 m-2 rounded-md">
